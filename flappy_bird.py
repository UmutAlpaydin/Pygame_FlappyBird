...
# This if statement creates an mathematical animation so that if floor_x_pos passes the -576 point, it repositions the floor to the 0 in x axis.
    if floor_x_pos <= -576:
        floor_x_pos = 0
